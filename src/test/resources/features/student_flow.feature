Feature: Student flow
  ...
  Scenario: A user with student authorities has no access to delete a group information
  ...
  Scenario: A user with student authorities should be able to list all groups
